...
Data Collection — Historical macroeconomic data (e.g. GDP, unemployment, stock indices) collected for past recessions alongside COVID-19 period data.
Preprocessing — Data cleaning, normalization, and feature engineering to align recession timelines for comparison.
Modelling — Multiple ML algorithms applied to learn recovery patterns from historical recessions.
Prediction — Trained models used to forecast economic recovery metrics for the COVID-19 period.
Evaluation — Model performance assessed and predictions compared against actual post-pandemic economic data.
...
bash   git clone https://github.com/fireball28/Predicting-the-Economic-Recovery-from-the-Covid-19-Pandemic-using-Previous-Recessions.git
   cd Predicting-the-Economic-Recovery-from-the-Covid-19-Pandemic-using-Previous-Recessions

Launch Jupyter Notebook:

bash   jupyter notebook proj.ipynb

Run all cells sequentially from top to bottom.


Report
A detailed write-up of the project — including the research motivation, full methodology, results, and conclusions — is available in Report.pdf.
